    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-100 p-4">
      <div className="max-w-md mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4 pt-8 pb-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-purple-800">Mistake Logbook</h1>
            <p className="text-purple-600 text-sm">Learn from every mistake</p>
          </div>
        </div>
        ...
        <Card className="shadow-lg border-0">
          <CardHeader>
            <CardTitle className="text-purple-800">New Problem Entry</CardTitle>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              <Label htmlFor="topic" className="text-purple-700">Topic *</Label>
              <Input
                id="topic"
            ...
            <div className="space-y-2">
              <Label htmlFor="description" className="text-purple-700">What went wrong? *</Label>
              <Textarea
                id="description"
            ...
            <div className="space-y-4">
              <div className="space-y-3">
                <Label className="text-purple-700">Problem Image</Label>
                {problemImage ? (
                  ...
                  <Button
                    variant="outline"
                    onClick={() => handleImageUpload('problem')}
                    className="w-full h-24 border-2 border-dashed border-purple-300 hover:border-purple-400 hover:bg-purple-50"
                  >
                    <div className="text-center">
                      <Camera className="h-8 w-8 mx-auto mb-2 text-purple-500" />
                      <span className="text-purple-600">Capture Problem</span>
                    </div>
                  </Button>
                )}
              </div>
              ...
              <div className="space-y-3">
                <Label className="text-purple-700">Solution Image</Label>
                {solutionImage ? (
                  <div className="relative">
                    <img 
                      src={solutionImage} 
                  ...
                  >
                    <div className="text-center">
                      ...
                      <span className="text-purple-600">Add Solution</span>
                    </div>
                  </Button>
                )}
              </div>
